...
3. 至少调用三个工具，且必须包含 list_files、search_code、read_file
...
Final Answer: {
  ...
  "recommended_tools": {
    "must_use": ["read_file", "search_code", "dataflow_analysis"],
    "recommended": ["quick_audit", "smart_scan", "vulnerability_validation"],
    "reason": "基于当前代码结构的建议"
  },
  "summary": "..."
}
